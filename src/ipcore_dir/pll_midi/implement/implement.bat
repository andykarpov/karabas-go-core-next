...
xst -ifn xst.scr
move pll_midi_exdes.ngc results\

REM  Copy the constraints files generated by Coregen
echo 'Copying files from constraints directory to results directory'
copy ..\example_design\pll_midi_exdes.ucf results\

cd results

echo 'Running ngdbuild'
ngdbuild -uc pll_midi_exdes.ucf pll_midi_exdes

echo 'Running map'
map -timing -pr b pll_midi_exdes -o mapped.ncd
...
netgen -ofmt vhdl -sim -tm pll_midi_exdes -w routed.ncd routed.vhd
cd ..
